...
if ARCHIVO <> "" then
	...
	cmd.CommandText = "EXEC SALESUP_CT.DBO.SP_MUEVE_DOC '"&TIPODOC&"', '" & CARPETA &"', '" & ARCHIVO & "' " 
	Set rs = cmd.execute
	Response.write "EXEC SALESUP_CT.DBO.SP_MUEVE_DOC '"&TIPODOC&"', '" & CARPETA &"', '" & ARCHIVO & "' "
	
	Response.write "<br/> Borrado"
