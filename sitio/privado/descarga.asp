...
if ARCHIVO <> "" then
	...
	cmd.CommandText = "EXEC SALESUP_CT.DBO.SP_DESCARGA_DOC '"&TIPODOC&"', '" & CARPETA &"', '" & ARCHIVO & "' " 
	Set rs = cmd.execute
	'Response.write "EXEC SALESUP_CT.DBO.SP_DESCARGA_DOC '"&TIPODOC&"', '" & CARPETA &"', '" & ARCHIVO & "' "
	    	 	


RutaArch = "C:\sitios\SalesUp\docs\"
