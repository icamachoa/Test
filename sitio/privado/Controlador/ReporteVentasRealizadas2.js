...
function CargaGraficaPie(_DatosPie){
	...
	chart = new Highcharts.Chart({
	    ...
	    tooltip: {
		    shared: false,
			formatter: function() {
				return '<b>'+ this.point.name +'xxx</b><br /><b>'+ SalesUp.Sistema.FormatoMoneda(this.point.y)+'</b>'+'<br> <b style="font-size:10px;"> Clic para ver detalle</b>';//SalesUp.Sistema.SimboloPorcentaje({Numero:this.point.percentage});
			}
...
function cargaGraficaComparativa(){
    ...
    var montoEneroPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoEnero);
    var montoFebreroPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoFebrero);
    var montoMarzoPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoMarzo);
    var montoAbrilPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoAbril);
    var montoMayoPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoMayo);
    var montoJunioPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoJunio);
    var montoJulioPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoJulio);
    var montoAgostoPorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoAgosto);
    var montoSeptiembrePorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoSeptiembre);
    var montoOctubrePorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoOctubre);
    var montoNoviembrePorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoNoviembre);
    var montoDiciembrePorCobrar= parseFloat(SalesUp.Variables.ArrayTotales[0].montoDiciembre);
	...
	chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Reporte de ventas nuevas vs recompra'
            },
            xAxis: {
...
SalesUp.Variables.CrearTotales = function(){
	...
	for (var i = 0; i < sumTotales.length; i++) {
		...
		if(i!=12)
			$('.Totales').append('<td class="tDer" data-sum="'+(i+1)+'"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+8+'&mes='+(i+1)+'&moneda='+moneda+'&parametros=0"><b>'+montoActual+'</b></td>');
		else
			$('.Totales').append('<td class="tDer" data-sum="'+(i+1)+'"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+8+'&mes=0&moneda='+moneda+'&parametros=0"><b>'+montoActual+'</b></td>');
...
SalesUp.Variables.CargaReportePeriodo = function(){
	...
	setTimeout(function(){
		...
		if(actividad == 2 || actividad == 5){
			...
			if(jsonDatosActividad0[0].MONTO_ENE){
			...
			var templateCuerpo	= '<tr>'
									...
									+' <td class="tDer enero_{{contador}}" data-enero="{{MONTO_ENE}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=1&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_ENE}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer febrero_{{contador}}" data-febrero="{{MONTO_FEB}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=2&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_FEB}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer marzo_{{contador}}" data-marzo="{{MONTO_MAR}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=3&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_MAR}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer abril_{{contador}}" data-abril="{{MONTO_ABR}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=4&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_ABR}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer mayo_{{contador}}" data-mayo="{{MONTO_MAY}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=5&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_MAY}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer junio_{{contador}}" data-junio="{{MONTO_JUN}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=6&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_JUN}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer julio_{{contador}}" data-julio="{{MONTO_JUL}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=7&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_JUL}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer agosto_{{contador}}" data-agosto="{{MONTO_AGO}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=8&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_AGO}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer septiembre_{{contador}}" data-septiembre="{{MONTO_SEP}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=9&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_SEP}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer octubre_{{contador}}" data-octubre="{{MONTO_OCT}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=10&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_OCT}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer noviembre_{{contador}}" data-noviembre="{{MONTO_NOV}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=11&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_NOV}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									...
									+' <td class="tDer diciembre_{{contador}}" data-diciembre="{{MONTO_DIC}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=12&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_DIC}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									
									+' <td class="tDer"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux2+'&tipo='+vista+'&mes=0&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_TOTAL_AUX}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividadAux1+'&tipo='+vista+'&mes=0&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_TOTAL}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+'</tr>';
		}else{
			...
			var templateCuerpo	= '<tr>'
									...
									+' <td class="tDer enero_{{contador}} sumaTotal" data-dato="{{MONTO_ENE}}" data-enero="{{MONTO_ENE}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=1&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_ENE}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer febrero_{{contador}} sumaTotal" data-dato="{{MONTO_FEB}}" data-febrero="{{MONTO_FEB}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=2&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_FEB}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer marzo_{{contador}} sumaTotal" data-dato="{{MONTO_MAR}}" data-marzo="{{MONTO_MAR}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=3&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_MAR}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer abril_{{contador}} sumaTotal" data-dato="{{MONTO_ABR}}" data-abril="{{MONTO_ABR}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=4&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_ABR}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer mayo_{{contador}} sumaTotal" data-dato="{{MONTO_MAY}}" data-mayo="{{MONTO_MAY}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=5&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_MAY}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer junio_{{contador}} sumaTotal" data-dato="{{MONTO_JUN}}" data-junio="{{MONTO_JUN}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=6&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_JUN}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer julio_{{contador}} sumaTotal" data-dato="{{MONTO_JUL}}" data-julio="{{MONTO_JUL}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=7&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_JUL}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer agosto_{{contador}} sumaTotal" data-dato="{{MONTO_AGO}}" data-agosto="{{MONTO_AGO}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=8&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_AGO}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer septiembre_{{contador}} sumaTotal" data-dato="{{MONTO_SEP}}" data-septiembre="{{MONTO_SEP}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=9&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_SEP}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer octubre_{{contador}} sumaTotal" data-dato="{{MONTO_OCT}}" data-octubre="{{MONTO_OCT}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=10&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_OCT}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer noviembre_{{contador}} sumaTotal" data-dato="{{MONTO_NOV}}" data-noviembre="{{MONTO_NOV}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=11&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_NOV}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer diciembre_{{contador}} sumaTotal" data-dato="{{MONTO_DIC}}" data-diciembre="{{MONTO_DIC}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=12&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_DIC}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+' <td class="tDer sumaTotal" data-dato="{{MONTO_TOTAL}}"><a href="/privado/reportes_ventas_detalle.dbsp?periodo='+periodo+'&actividad='+actividad+'&tipo='+vista+'&mes=0&moneda='+moneda+'&parametros={{Parametros}}"><span class="">{{#MontoFormat Simbolo MONTO_TOTAL}}{{montoSalida}}{{/MontoFormat}}</span></a></td>'
									+'</tr>';
		}
