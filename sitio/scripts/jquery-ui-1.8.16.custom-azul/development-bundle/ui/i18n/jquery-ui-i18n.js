...
jQuery(function($){
	$.datepicker.regional['ar'] = {
		...
		nextText: 'OU,O¶OU,US&#x3e;',
		currentText: 'OU,USU^U.',
		monthNames: ['UüOU+U^U+ OU,OÆOU+US', 'O'O"OO˙', 'OõO¯OOÒ', 'U+USO3OU+', 'U.OUSU^', 'O-O˝USOÒOU+',
...
jQuery(function($){
	$.datepicker.regional['tj'] = {
		...
		monthNames: ['D_D´D˝D¯•_','DDÊD˝•_D¯DØ','DoD¯•_•,','D_D®•_DÊDØ','DoD¯D1','D~•ZD´',
		'D~•ZDØ','D_D˝D3•ü•_•,','D≠DÊD´•,•_DÒ•_','DzDß•,•_DÒ•_','D_D_•_DÒ•_','D"DÊDßD¯DÒ•_'],
		monthNamesShort: ['D_D´D˝','DDÊD˝','DoD¯•_','D_D®•_','DoD¯D1','D~•ZD´',
		'D~•ZDØ','D_D˝D3','D≠DÊD´','DzDß•,','D_D_•_','D"DÊDß'],
		dayNames: ['•_Dß•^D¯D´DÒDÊ','D'•ü•^D¯D´DÒDÊ','•_DÊ•^D¯D´DÒDÊ','•ÿD_•_•^D¯D´DÒDÊ','D®D¯D´O˙•^D¯D´DÒDÊ','O˙•üD¨•SD¯','•^D¯D´DÒDÊ'],
		dayNamesShort: ['•_Dß•^','D'•ü•^','•_DÊ•^','•ÿD_•_','D®D¯D´','O˙•üD¨','•^D¯D´'],
		dayNamesMin: ['D_Dß','D"•^','D≠•^','D•^','DY•^','OD¨','D"D´'],
		weekHeader: 'Dù•,',
		dateFormat: 'dd.mm.yy',
		firstDay: 1,
		isRTL: false,
