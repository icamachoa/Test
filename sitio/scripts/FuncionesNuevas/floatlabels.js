...
;(function ( $, window, document, undefined ) {
        ...
        Plugin.prototype = {
            init: function () {
                ...
                var floatingText        = thisElement.data('span');
                ...
                thisElement.before('<span for="' + elementID + '" class="label-floatlabel ' + settings.labelClass + ' ' + extraClasses + '">' + floatingText + '</span>');
                this.$label = thisElement.prev('span');
                this.$label.css({
                    'position'                      : 'absolute',
                ...
                thisElement.on('blur', function() { thisElement.prev('span').css({ 'color' : '#838780' }); });
                thisElement.on('focus', function() { thisElement.prev('span').css({ 'color' : '#2996cc' }); });
