//[idcita|Integer,session.idusuario|Untyped,session.idempresa|Untyped,session.convertcode|Untyped,tipoidseleccionado|Text,idseleccionado|Text,donde|Text,asunto|Text,fechacitainicio|Text,horacitainicio|Text,fechacitafin|Text,horacitafin|Text,idplantillacorreo|Integer,idplantillasms|Integer,tiempoplantilla|Integer,descripcion|Text,repetir|Integer,terminar|Integer,fecharepetir|Text,cada|Integer,diasrecurrencia|Text,diasmes|Text,idplantillacorreonoti|Integer,idplantillasmsnoti|Integer,notifica|Integer,session.db|Untyped,]
--INSERT
DECLARE @IDCITA INT
...
SET @IDCITA=CAST(ISNULL(:IDCITA,0) AS INT)
...
EXEC <#SESSION.DB/>.dbo.SP_EDITAR_CITA
    @IDCITA,
	@IDUSUARIOSESSION,
	@IDEMPRESA,
	@CONVERTCODE,
