//[tipousuario|Integer,idtc|Integer,c|Integer,idticket|Text,tkt|Text,idestado|Integer,session.idusuario|Untyped,visto|Integer,SESSION.CONVERTCODE|Untyped]
--UPDATE
DECLARE @IDTC INT, @C INT, @IDTICKET INT
DECLARE @TIPOUSUARIO INT
SET @TIPOUSUARIO=ISNULL(:TIPOUSUARIO,0) 
