...
BEGIN
	 ...
	 --SET @URL = CONTROL.TICKETS.DBO.GeneraUrl(<#SESSION.IDPRODUCTO/>,<#SESSION.IDEMPRESA/>, 1) + @ARCHIVO
...
VALUES (<#SESSION.IDPRODUCTO/>,<#SESSION.IDEMPRESA/>, <#SESSION.IDUSUARIO/>, :DEPARTAMENTO, :ASUNTO, :DESCRIPCION, :TICKETNORMALIZADO, @URL, 1, @FECHA, 1, <#SESSION.IDUSUARIO/>,'',1,:SP_BROWSER)
