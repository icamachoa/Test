//[filtrodetalleopc|Integer,filtrodetallereportes2|Text,session.db|Untyped,session.idusuario|Untyped,idpantalla|Integer,]
--INSERT
...
SET @TIPO=ISNULL(:FiltroDetalleOpc,0)
