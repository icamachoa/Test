...
SET @SQL='
SELECT count(*) as TOTALN , '''+CAST(@TKPI AS VARCHAR(256))+''' AS TKPI, '''+CAST(@TK AS VARCHAR(256))+''' AS TK, '''+CAST(@TKAUTO AS VARCHAR(256))+''' AS TKAUTO, '+CAST(@IDPIEZA AS VARCHAR(1000))+' AS IDPIEZA, '+CAST(@IDAUTORESPONDER AS VARCHAR(1000))+' AS IDAUTORESPONDER, '+CAST(@IDETIQUETA AS VARCHAR(1000))+' AS IDETIQUETA,
