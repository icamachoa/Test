...
SET @SQL = ''
SET @SQL='
SELECT COUNT(DISTINCT P.IDPROSPECTO) AS TOTALN, '''+@FECHA_INICIAL+''' AS FECHA_DESDE, '''+@FECHA_FINAL+''' AS FECHA_HASTA, '+CAST(@TIPO AS VARCHAR(1000))+' AS TIPO, '+CAST(@IDUSUARIO AS VARCHAR(1000))+' AS IDUSUARIO
