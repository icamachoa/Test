...
SET @EXECSQL = 'SELECT CONVERT(VARCHAR,VC.FECHAHORA,20) AS FECHAHORA,'+@IDUSUARIO+' AS IDUSUARIO,'''+@FECHA+''' AS FECHA, VC.* from '+@BD+'.dbo.ventas V WITH (NOLOCK), '+@BD+'.dbo.ventas_COBROS VC WITH (NOLOCK) '
