...
SELECT IdCampo as IdCampoPer ,Indice as IdC, 
CASE 
WHEN TIPO IN (1,3) OR COMPARTIR IN (1,3) THEN 'P' 
WHEN TIPO IN (2,4) OR COMPARTIR IN (2,4) THEN 'O' 
END AS De,
NOMBRE_CAMPO AS Campo, Descripcion as Tip, Largo AS Max,
