//[session.db|Untyped,session.idempresa|Untyped,session.idusuario|Untyped,session.nivel|Untyped,session.idgrupo|Untyped,session.mailconfig|Untyped,tkcom|Text,idpantalla|Integer,session.multimoneda|Untyped,]
--SELECT 
