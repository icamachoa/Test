//[session.db|Untyped,session.convertcode|Untyped,session.idusuario|Untyped,session.idempresa|Untyped,idoportunidad|Integer,]
--select
SELECT 
 TOP 1 
 SALESUP_CT.dbo.esCanalizado(O.TKO, O.TKOM) AS esCanalizado, SALESUP_CT.dbo.esCanalizado(P.TKP, P.TKPM) AS ProspectoCanalizado,TKO,
 ...
 (SELECT CASE WHEN COUNT(PA1.IDPROSPECTO) > 0 THEN '1' ELSE '' END FROM <#SESSION.DB/>.DBO.PROSPECTOS_ASIGNADOS PA1 WHERE PA1.IDPROSPECTO = P.IDPROSPECTO AND P.IDUSUARIO != PA1.IDUSUARIO) AS COMPARTIDO,
  ...
  (SELECT ESTADO FROM <#SESSION.DB/>.DBO.ESTADOS WHERE IDESTADO = COM.IDESTADO AND IDPAIS=COM.IDPAIS) AS ESTADOEMPRESA, COM.NEMPLEADOS AS NEMPRESA,
   ...
   INDUSTRIA, COMPANIAGRUPO, O.IDDOCUMENTO AS TIENECOTIZACION,
  ...
  P.CAMPO35 AS CAMPO35P, P.CAMPO36 AS CAMPO36P, P.CAMPO37 AS CAMPO37P, P.CAMPO38 AS CAMPO38P, P.CAMPO39 AS CAMPO39P, 
  P.CAMPO40 AS CAMPO40P, P.CAMPO41 AS CAMPO41P, P.CAMPO42 AS CAMPO42P, P.CAMPO43 AS CAMPO43P, P.CAMPO44 AS CAMPO44P, 
  P.CAMPO45 AS CAMPO45P, P.CAMPO46 AS CAMPO46P, P.CAMPO47 AS CAMPO47P, P.CAMPO48 AS CAMPO48P, P.CAMPO49 AS CAMPO49P, 
  P.CAMPO50 AS CAMPO50P, P.CAMPO51 AS CAMPO51P, P.CAMPO52 AS CAMPO52P, P.CAMPO53 AS CAMPO53P, P.CAMPO54 AS CAMPO54P, 
  P.CAMPO55 AS CAMPO55P, P.CAMPO56 AS CAMPO56P, P.CAMPO57 AS CAMPO57P, P.CAMPO58 AS CAMPO58P, P.CAMPO59 AS CAMPO59P, 
  P.CAMPO60 AS CAMPO60P, P.CAMPO61 AS CAMPO61P, P.CAMPO62 AS CAMPO62P, P.CAMPO63 AS CAMPO63P, P.CAMPO64 AS CAMPO64P,
